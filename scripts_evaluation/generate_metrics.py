...
MODELS_CONFIG = [
    ...
    },
    {
        ...
        "data_dir": "../aegis_data/damage/data1a/validation", # Point directly to validation folder
        "label_mode": "categorical",
    ...
    },
    {
        ...
        # THE FIX: Added /images to bypass the annotations folder
...
for config in MODELS_CONFIG:
    ...
    # THE FIX: Conditionally apply the split based on dataset folder structure
    ...
    print(f"Running AI Inference for {model_name}. This may take a minute...")
    ...
    plt.close()
    print(f"[OK] Saved metric image to: {output_filename}")
