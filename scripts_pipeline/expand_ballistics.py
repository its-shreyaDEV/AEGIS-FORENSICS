...
# Point to your cleanly organized folders
SOURCE_DIR = "aegis_data/ballistics_ready"

# We want to generate 10 new variations for every 1 original image
MULTIPLIER = 10 

print(f"Initializing Data Expansion Pipeline...")

# Configure the physics of our synthetic generation
# We focus heavily on rotation and lighting, as casing marks 
# look completely different under different microscope lights.
datagen = ImageDataGenerator(
    ...
    vertical_flip=True,
    fill_mode='nearest' # Fills in corners if the image spins
)
...
print("Your dataset is now large enough to prevent 100% memorization.")